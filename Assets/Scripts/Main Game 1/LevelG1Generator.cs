...
public class LevelG1Generator : MonoBehaviour
{
    ...
    {
        int totalNodes = 4 + GameSettings.DifficultyG1 * 2;
        int totalEdges = 4 + GameSettings.DifficultyG1 * 2;
        ...
        return new Level(GameSettings.DifficultyG1, nodePositions, edgeNodes.ToArray());
